...
public class GoogleDriveSource {
	...
	@Column(name = "google_drive_id", length = 255)
	...
	@Column(name = "discovery_run_id", length = 36)
	...
	public void prePersist() {
		...
		if (status == null) {
			status = GoogleDriveSourceStatus.ACTIVE;
		}

		if (capabilities == null) {
			capabilities = new GoogleDriveSourceCapabilities();
		}

		if (restrictions == null) {
			restrictions = new GoogleDriveSourceRestrictions();
		}
