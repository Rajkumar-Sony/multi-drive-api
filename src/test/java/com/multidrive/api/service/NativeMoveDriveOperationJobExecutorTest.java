...
class NativeMoveDriveOperationJobExecutorTest {
    ...
    private static final Long JOB_ID =
            10L;
    ...
    @Mock
    private GoogleDriveFileMutationService
            googleDriveFileMutationService;

    @Mock
    private DriveOperationLocalStateService
            driveOperationLocalStateService;

    @Mock
    private DriveOperationJobStateService
            driveOperationJobStateService;

    @Mock
    private GoogleDriveFileCapabilitiesResponse
            sourceCapabilities;
    ...
    void setUp() {
        ...
        executor =
                new NativeMoveDriveOperationJobExecutor(
                        googleDriveFileMutationService,
                        new DriveOperationCapabilityGuard(),
                        driveOperationLocalStateService,
                        driveOperationJobStateService
                );
    }
    ...
    void executeMovesRemoteFileAndCompletesJob() {
        ...
        GoogleDriveFileResponse currentFile =
                file(
                        "file-1",
                        List.of(
                                "old-parent"
        ...
        GoogleDriveFileResponse destinationFolder =
                file(
                        "dest-parent",
                        List.of(),
                        false,
        ...
        GoogleDriveFileResponse movedFile =
                file(
                        "file-1",
                        List.of(
                                "dest-parent"
    ...
    void executeCommitsAlreadyMovedRemoteFileWithoutMovingAgain() {
        ...
        GoogleDriveFileResponse alreadyMovedFile =
                file(
                        "file-1",
                        List.of(
                                "dest-parent"
    ...
    private DriveOperationJobExecutionSnapshot nativeMoveJob() {
        ...
        return new DriveOperationJobExecutionSnapshot(
                JOB_ID,
                99L,
                "google-subject-123",
                DriveOperationType.MOVE,
                DriveOperationStrategyType.NATIVE_MOVE,
                DriveOperationJobStatus.VALIDATING,
                123L,
                20L,
                30L,
                "file-1",
