...
@Service
public class GoogleDriveContentStreamingServiceImpl
        implements GoogleDriveContentStreamingService {
    ...
    public GoogleDriveContentStreamingServiceImpl(
    ...
    public void streamExport(
        ...
        if (exportMimeType == null
                || exportMimeType.isBlank()) {

            throw new IllegalArgumentException(
                    "exportMimeType is required"
            );
        }
    ...
    private void streamGoogleResponse(
            URI uri,
            String accessToken,
            OutputStream outputStream,
            String operation
