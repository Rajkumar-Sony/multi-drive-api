...
@Service
public class DriveUploadServiceImpl
        implements DriveUploadService {
    ...
    private final GoogleDriveResumableUploadService
            googleDriveResumableUploadService;
    ...
    public DriveUploadServiceImpl(
        ...
        this.googleDriveResumableUploadService =
                googleDriveResumableUploadService;
    ...
    private UploadDestination resolveDestination(
            String googleSubjectId,
            Long sourceId,
            Long parentItemId
    ) {
        ...
        if (parentItemId == null) {
            ...
            return resolveSourceRootDestination(
                    googleSubjectId,
                    sourceId
            );
        }

        return resolveFolderDestination(
                googleSubjectId,
                sourceId,
                parentItemId
        );
    ...
    private UploadDestination resolveSourceRootDestination(
            String googleSubjectId,
            Long sourceId
    ) {
        ...
        GoogleDriveFileResponse remoteParent =
                googleDriveFileMutationService
                        .getFile(
                                connection.getId(),
                                userId,
    ...
    private UploadDestination resolveFolderDestination(
            String googleSubjectId,
            Long sourceId,
            Long parentItemId
    ) {
        ...
        if (parent.isTrashed()) {
            ...
            throw new IllegalArgumentException(
                    "Cannot upload into a trashed folder"
            );
        }
        ...
        if (source == null
            ...
            throw new IllegalStateException(
                    "Parent Drive source is missing"
            );
        }
    ...
    private GoogleDriveConnection requireConnection(
        ...
        if (source.getConnection() == null
            ...
            throw new IllegalStateException(
                    "Drive source connection is missing"
            );
        }
