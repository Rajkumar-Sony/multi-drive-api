...
public class DriveOperationServiceImpl
    ...
    public DriveItemDetailsResponse move(
        ...
        if (item.isTrashed()) {
            ...
            throw new IllegalArgumentException(
                    "Cannot move an item while it is in trash"
            );
        }
        ...
        requireNativeStrategy(
                plan,
                DriveOperationStrategyType.NATIVE_MOVE
        );

        validateFolderMoveHierarchy(
                item,
                destination
        );
        ...
        if (Boolean.TRUE.equals(
            ...
            throw new IllegalArgumentException(
                    "Cannot move an item while it is in Google Drive trash"
            );
        }

        if (hasParent(
                currentRemoteFile.parents(),
        ...
        GoogleDriveFileResponse remoteDestinationParent =
                googleDriveFileMutationService
                        .getFile(
                                destination.connection().getId(),
                                destination.userId(),
                                destination.parentGoogleFileId()
                        );

        if (Boolean.TRUE.equals(
                remoteDestinationParent.trashed()
        )) {
        ...
        driveOperationCapabilityGuard
                .requireAllowed(
                        remoteDestinationParent.capabilities() != null
                                ? remoteDestinationParent
                                        .capabilities()
                                        .canAddChildren()
                                : null,
                        "MOVE",
                        "Cannot add items to the destination folder"
                );

        GoogleDriveFileResponse movedRemoteFile =
                googleDriveFileMutationService
                        .move(
                                connection.getId(),
                                userId,
    ...
    public DriveItemDetailsResponse copy(
        ...
        if (item.isTrashed()) {
            ...
            throw new IllegalArgumentException(
                    "Cannot copy an item while it is in trash"
            );
        }
        ...
        if (Boolean.TRUE.equals(
            ...
            throw new IllegalArgumentException(
                    "Cannot copy an item while it is in Google Drive trash"
            );
        }
        ...
        GoogleDriveFileResponse copiedRemoteFile =
                googleDriveFileMutationService
                        .copy(
                                connection.getId(),
                                userId,
        ...
        GoogleDriveItemSourceType destinationSourceType =
    ...
    private DriveItemDetailsResponse createFolderInSourceRoot(
            String googleSubjectId,
            Long sourceId,
            String name
    ) {
    ...
    private DriveItemDetailsResponse createFolderInsideFolder(
            String googleSubjectId,
            Long sourceId,
            Long parentItemId,
            String name
    ...
    private DestinationContext resolveDestination(
            String googleSubjectId,
    ...
    private void validateFolderMoveHierarchy(
    ...
    private void requireNativeStrategy(
            DriveOperationPlan plan,
            DriveOperationStrategyType expectedStrategy
    ) {
