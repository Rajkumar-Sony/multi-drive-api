...
public class DriveOperationJobExecutionStore {
    ...
    public DriveOperationJobExecutionStore(
    ...
    public Optional<Long> claimNextNativeMove(
            String workerId,
            LocalDateTime now,
    ...
    public Optional<DriveOperationJobExecutionSnapshot>
    findExecutionSnapshot(
        ...
        List<DriveOperationJobExecutionSnapshot> results =
                jdbcTemplate.query(
                        sql,
                        (
                                resultSet,
                                ...
                                new DriveOperationJobExecutionSnapshot(
                                        resultSet.getLong(
                                                "id"
                                        ),
                                        resultSet.getLong(
                                        ...
                                        DriveOperationType.valueOf(
                                                resultSet.getString(
                                                        "operation_type"
                                                )
                                        ),
                                        DriveOperationStrategyType.valueOf(
                                                resultSet.getString(
                                                        "strategy_type"
                                                )
                                        ),
                                        DriveOperationJobStatus.valueOf(
                                                resultSet.getString(
                                                        "status"
                                                )
                                        ),
    ...
    public Optional<DriveOperationJobProgressSnapshot>
    findProgressSnapshot(
        ...
        List<DriveOperationJobProgressSnapshot> results =
                jdbcTemplate.query(
                        sql,
                        (
                                resultSet,
                                ...
                                new DriveOperationJobProgressSnapshot(
                                        resultSet.getLong(
                                                "id"
                                        ),
                                        resultSet.getString(
    ...
    public void completeNativeMove(
        ...
        if (itemUpdated != 1) {
            ...
            throw new IllegalStateException(
                    "Root operation item could not be completed"
            );
        }
        ...
        if (jobUpdated != 1) {
            ...
            throw new IllegalStateException(
                    "Drive operation job could not be completed"
            );
        }
    }
    ...
    public boolean markFailure(
        ...
        if (terminalStatus
                != DriveOperationJobStatus.FAILED
                && terminalStatus
                != DriveOperationJobStatus.CLEANUP_REQUIRED) {

            throw new IllegalArgumentException(
                    "Invalid terminal failure status"
            );
        }
        ...
        DriveOperationItemStatus itemStatus =
                terminalStatus
                        == DriveOperationJobStatus.CLEANUP_REQUIRED
                        ? DriveOperationItemStatus.CLEANUP_REQUIRED
                        : DriveOperationItemStatus.FAILED;
    ...
    public void releaseRejectedClaim(
            Long jobId,
            String workerId,
