...
@Service
public class DriveOperationJobServiceImpl
        implements DriveOperationJobService {
    ...
    private final DriveOperationJobRepository
            driveOperationJobRepository;

    private final DriveOperationItemRepository
    ...
    private final DriveOperationPlanner
            driveOperationPlanner;

    private final TransactionTemplate
            transactionTemplate;

    public DriveOperationJobServiceImpl(
            DriveOperationJobRepository driveOperationJobRepository,
            ...
            DriveOperationPlanner driveOperationPlanner,
            PlatformTransactionManager transactionManager
    ) {

        this.driveOperationJobRepository =
                driveOperationJobRepository;

        this.driveOperationItemRepository =
                driveOperationItemRepository;
    ...
    public DriveOperationJobResponse submit(
        ...
        if (normalizedIdempotencyKey != null) {
            ...
            DriveOperationJobResponse existing =
                    findExistingIdempotentJob(
                            googleSubjectId,
        ...
        try {
            ...
            if (jobId == null) {
                ...
                throw new IllegalStateException(
                        "Drive operation job was not created"
                );
            }
    ...
    public DriveOperationJobResponse getJob(
        ...
        return driveOperationJobRepository
                .findResponseByIdAndGoogleSubjectId(
                        jobId,
                        googleSubjectId
                )
                .orElseThrow(
                        () -> new DriveOperationJobNotFoundException(
                                jobId
                        )
                );
    }
    ...
    public DriveOperationJobsPageResponse getJobs(
        ...
        Page<DriveOperationJobResponse> result =
                status == null
                        ? driveOperationJobRepository
                                .findResponsesByGoogleSubjectId(
                                        googleSubjectId,
                                        pageable
                                )
                        : driveOperationJobRepository
                                .findResponsesByGoogleSubjectIdAndStatus(
                                        googleSubjectId,
                                        status,
                                        pageable
                                );

        return new DriveOperationJobsPageResponse(
                result.getContent(),
                result.getNumber(),
                result.getSize(),
        ...
        transactionTemplate
                .executeWithoutResult(
                        status -> {
                            ...
                            DriveOperationJob job =
                                    driveOperationJobRepository
                                            .findByIdAndUser_GoogleSubjectId(
                                                    jobId,
                                                    googleSubjectId
                                            )
                                            .orElseThrow(
    ...
    private Long createJob(
        ...
        if (sourceItem.isTrashed()) {
            ...
            throw new IllegalArgumentException(
                    "Cannot submit a job for an item in trash"
            );
        }

        GoogleDriveConnection sourceConnection =
                requireConnection(
                        sourceItem
                );
        ...
        DriveOperationJob job =
                new DriveOperationJob();

        job.setUser(
                sourceConnection.getUser()
        );
        job.setOperationType(
                request.operationType()
        );
        job.setStrategyType(
                plan.strategyType()
        ...
        job.setConflictStrategy(
                conflictStrategy
        );
        job.setSourceItemId(
                sourceItem.getId()
        );
        job.setSourceConnectionId(
                sourceConnection.getId()
        );
        job.setSourceSourceId(
                source.getId()
        );
        job.setSourceGoogleFileId(
                sourceItem.getGoogleFileId()
        );
        job.setSourceName(
                sourceItem.getName()
        );
        job.setSourceMimeType(
                sourceItem.getMimeType()
        );
        job.setDestinationSourceId(
                destination.source()
                        .getId()
        );
        job.setDestinationConnectionId(
                requireConnection(
                        destination.source()
                )
                        .getId()
        );
        job.setDestinationParentItemId(
                destination.parentItemId()
        );
        job.setDestinationParentGoogleFileId(
                destination.parentGoogleFileId()
        );
        job.setRequestedName(
                requestedName
        );
        job.setTotalItems(
                1L
        );
        job.setCompletedItems(
                0L
        );
        job.setFailedItems(
                0L
        ...
        job.setTotalBytes(
                sourceItem.getSizeBytes()
        );
        job.setTransferredBytes(
                0L
        );
        job.setAttemptCount(
                0
        ...
        DriveOperationJob savedJob =
                driveOperationJobRepository
                        .saveAndFlush(
                                job
                        );

        DriveOperationItem operationItem =
                new DriveOperationItem();

        operationItem.setJob(
                savedJob
        );
        operationItem.setSequenceNo(
                0
        );
        operationItem.setSourceLocalItemId(
                sourceItem.getId()
        );
        operationItem.setSourceGoogleFileId(
                sourceItem.getGoogleFileId()
        );
        operationItem.setSourceName(
                sourceItem.getName()
        );
        operationItem.setSourceMimeType(
                sourceItem.getMimeType()
        );
        operationItem.setSourceParentGoogleFileId(
                sourceItem.getParentId()
        );
        operationItem.setDestinationParentGoogleFileId(
                destination.parentGoogleFileId()
        );
        operationItem.setStatus(
                DriveOperationItemStatus.QUEUED
        );
        operationItem.setSizeBytes(
                sourceItem.getSizeBytes()
        );
        operationItem.setTransferredBytes(
                0L
        );
        operationItem.setAttemptCount(
                0
        );
    ...
    private DriveOperationJobResponse findExistingIdempotentJob(
            String googleSubjectId,
            String idempotencyKey
    ) {

        return driveOperationJobRepository
                .findResponseByGoogleSubjectIdAndIdempotencyKey(
                        googleSubjectId,
                        idempotencyKey
                )
                .orElse(
    ...
    private Destination resolveDestination(
        ...
        if (parent.getCategory()
            ...
            throw new IllegalArgumentException(
                    "destinationParentItemId must reference a folder"
            );
        }
        ...
        if (parent.isTrashed()) {
            ...
            throw new IllegalArgumentException(
                    "Destination folder is in trash"
            );
        }
        ...
        if (!source.getId()
            ...
            throw new IllegalArgumentException(
                    "destinationParentItemId does not belong to destinationSourceId"
            );
        }
    ...
    private DriveOperationPlan planOperation(
        ...
        DriveOperationPlan plan =
                operationType == DriveOperationType.MOVE
                        ? driveOperationPlanner
                                .planMove(
                                        sourceItem,
                                        destinationSource
        ...
        if (plan == null
                || plan.strategyType() == null) {

            throw new DriveOperationPlanningException(
                    "Drive operation planner returned no strategy"
            );
        }
    ...
    private void validateMoveHierarchy(
            DriveOperationType operationType,
            GoogleDriveItem sourceItem,
            Destination destination
    ) {

        if (operationType != DriveOperationType.MOVE
        ...
        GoogleDriveItem destinationParent =
    ...
    private GoogleDriveSource requireOwnedActiveSource(
            String googleSubjectId,
            Long sourceId
    ) {
        ...
        if (sourceId == null) {
            ...
            throw new IllegalArgumentException(
                    "destinationSourceId is required"
            );
        }
    ...
    private String requireRootFolderId(
            GoogleDriveSource source
    ) {
