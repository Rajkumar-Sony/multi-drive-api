...
@Service
public class GoogleDriveResumableUploadServiceImpl
        implements GoogleDriveResumableUploadService {

    private static final String GOOGLE_DRIVE_UPLOAD_URL =
            "https://www.googleapis.com/upload/drive/v3/files";

    private static final int UPLOAD_CHUNK_SIZE =
            8 * 1024 * 1024;

    private static final int HTTP_RESUME_INCOMPLETE =
            308;
    ...
    public GoogleDriveResumableUploadServiceImpl(
    ...
    @Override
    public GoogleDriveFileResponse upload(
            Long connectionId,
            Long userId,
    ...
    private URI initiateUploadSession(
            String accessToken,
            String parentGoogleFileId,
            String fileName,
            String contentType,
        ...
        GoogleDriveUploadMetadataRequest metadata =
                new GoogleDriveUploadMetadataRequest(
                        fileName,
                        contentType,
                        List.of(
                                parentGoogleFileId
    ...
    private GoogleDriveFileResponse uploadContent(
            URI sessionUri,
            String contentType,
            long totalLength,
            InputStreamProvider inputStreamProvider
        ...
        try (
            ...
            while (startOffset < totalLength) {
                ...
                if (bytesRead <= 0) {
                    ...
                    throw new IllegalStateException(
                            "Upload stream ended before the expected content length"
                    );
                }
                ...
                if (result.acknowledgedEndOffset()
                        != endOffset) {

                    throw new IllegalStateException(
                            "Google Drive did not acknowledge the complete upload chunk"
                    );
                }
            ...
            throw new IllegalStateException(
                    "Unable to read file content for Google Drive upload",
                    exception
            );
        }
    ...
    private UploadChunkResult uploadChunk(
            URI sessionUri,
            String contentType,
            byte[] chunk,
            long startOffset,
                        ...
                        (
                            ...
                            if (status
                                ...
                                long acknowledgedEndOffset =
                                        parseAcknowledgedEndOffset(
                                                range
                                        );

                                return new UploadChunkResult(
                                        false,
                                        acknowledgedEndOffset,
                                        null
                                );
                            }
                            ...
                            if (response
                                ...
                                try {
                                    ...
                                    throw new IllegalStateException(
                                            "Unable to parse Google Drive upload response",
                                            exception
                                    );
                                }
                            }
                            ...
                            throw new IllegalStateException(
                                    "Google Drive upload chunk failed with HTTP status "
                                            + status
                            );
                        }
                );
    ...
    private GoogleDriveFileResponse uploadEmptyFile(
            URI sessionUri,
            String contentType
    ) {
                ...
                .exchange(
                        (
                            ...
                            if (!response
                                ...
                                throw new IllegalStateException(
                                        "Google Drive empty-file upload failed with HTTP status "
                                                + response
                                                .getStatusCode()
                                                .value()
                                );
    ...
    private long parseAcknowledgedEndOffset(
            String range
    ) {
    ...
    private void validateRequest(
        ...
        if (parentGoogleFileId == null
                || parentGoogleFileId.isBlank()) {

            throw new IllegalArgumentException(
                    "parentGoogleFileId is required"
            );
        }
        ...
        if (contentLength < 0) {
            ...
            throw new IllegalArgumentException(
                    "contentLength must be 0 or greater"
            );
        }
        ...
        if (inputStreamProvider == null) {
            ...
            throw new IllegalArgumentException(
                    "inputStreamProvider is required"
            );
        }
    }
