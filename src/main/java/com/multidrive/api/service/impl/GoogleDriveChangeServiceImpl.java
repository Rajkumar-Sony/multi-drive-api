...
public class GoogleDriveChangeServiceImpl
    ...
    public GoogleDriveChangeTracker initializeUserTracker(
         ...
         *
         * That token represents our current sync position.
         * Replacing it could skip unprocessed Drive changes.
         */
    ...
    @Override
    public List<GoogleDriveChangeTracker>
    initializeSharedDriveTrackers(
        ...
        /*
         * Get one valid access token that will be used
         * for startPageToken calls for Shared Drives.
         */
        String accessToken =
                googleTokenService
                        .getValidAccessToken(
        ...
        do {
             ...
             *
             * We request the maximum supported page size
             * and continue until nextPageToken is absent.
             */
    ...
    private GoogleDriveChangeTracker
    initializeSharedDriveTracker(
            GoogleDriveConnection connection,
            String accessToken,
            String driveId
        ...
        /*
         * Existing tracker with a valid page token
         * must keep its current sync position.
         */
        if (existingTracker.isPresent()
                && hasPageToken(existingTracker.get())) {
    ...
    private String fetchStartPageToken(
            String accessToken,
            String driveId
    ) {
         ...
         *
         * When driveId is null, Google returns the
         * starting token for the user's change log.
         */
        if (driveId != null
                && !driveId.isBlank()) {
    ...
    private GoogleDriveConnection findConnection(
            Long connectionId,
            Long userId
    ) {
