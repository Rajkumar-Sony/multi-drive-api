...
public interface GoogleDriveSourceRepository
        extends JpaRepository<
                GoogleDriveSource,
                Long
        > {

    List<GoogleDriveSource>
    ...
    findByConnection_IdAndSourceTypeAndGoogleDriveIdIsNull(
            Long connectionId,
            GoogleDriveSourceType sourceType
    );

    Optional<GoogleDriveSource>
    findByConnection_IdAndSourceTypeAndGoogleDriveId(
            Long connectionId,
            GoogleDriveSourceType sourceType,
    ...
    @Query("""
            ...
            ORDER BY
                ...
                source.name ASC
            """)
    List<GoogleDriveSourceResponse>
    ...
    @Query("""
            ...
            """)
    int markUndiscoveredSharedDriveSourcesInactive(
            @Param("connectionId")
            Long connectionId,
            ...
            @Param("activeStatus")
            GoogleDriveSourceStatus activeStatus,

            @Param("inactiveStatus")
            GoogleDriveSourceStatus inactiveStatus,

            @Param("discoveryRunId")
