...
@Service
public class NativeMoveDriveOperationJobExecutor
        implements DriveOperationJobExecutor {
    ...
    public NativeMoveDriveOperationJobExecutor(
            GoogleDriveFileMutationService
                    googleDriveFileMutationService,
            DriveOperationCapabilityGuard
                    driveOperationCapabilityGuard,
    ...
    public void execute(
        ...
        if (driveOperationJobStateService
                .cancelIfRequested(
                        job.jobId(),
                        workerId
                )) {
        ...
        if (Boolean.TRUE.equals(
            ...
            throw new IllegalArgumentException(
                    "Source item is currently in Google Drive trash"
            );
        }

        GoogleDriveFileResponse destinationRemoteFolder =
                googleDriveFileMutationService
                        .getFile(
        ...
        if (Boolean.TRUE.equals(
                destinationRemoteFolder.trashed()
        )) {

            throw new IllegalArgumentException(
                    "Destination folder is currently in Google Drive trash"
            );
        }
            ...
            driveOperationCapabilityGuard
                    .requireAllowed(
                            currentRemoteFile.capabilities() != null
                                    ...
                                    : null,
                            "MOVE",
                            "Google no longer allows the source item to move within this Drive"
                    );
            ...
            driveOperationCapabilityGuard
                    .requireAllowed(
                            destinationRemoteFolder.capabilities() != null
                                    ...
                                    : null,
                            "MOVE",
                            "Google no longer allows items to be added to the destination folder"
                    );
        }
        ...
        driveOperationJobStateService
                .transition(
                        job.jobId(),
                        workerId,
                        DriveOperationJobStatus.PLANNING,
                        alreadyMoved
                                ? "Remote item is already at the requested destination"
                                : "Native move plan validated"
                );
        ...
        if (!alreadyMoved) {
            ...
            driveOperationJobStateService
                    .transition(
                            job.jobId(),
                            workerId,
                            DriveOperationJobStatus.RUNNING,
        ...
        driveOperationJobStateService
                .transition(
                        job.jobId(),
                        workerId,
                        DriveOperationJobStatus.VERIFYING,
        ...
        GoogleDriveFileResponse verifiedRemoteFile =
                googleDriveFileMutationService
                        .getFile(
                                job.sourceConnectionId(),
                                job.userId(),
        ...
        if (Boolean.TRUE.equals(
                verifiedRemoteFile.trashed()
        )) {

            throw new IllegalStateException(
                    "Google Drive move verification failed because the item is now trashed"
            );
        }
        ...
        driveOperationJobStateService
                .transition(
                        job.jobId(),
                        workerId,
                        DriveOperationJobStatus.COMMITTING,
    ...
    private void validateJob(
        ...
        if (job.operationType()
                != DriveOperationType.MOVE) {

            throw new IllegalArgumentException(
                    "NATIVE_MOVE executor only accepts MOVE jobs"
            );
        }
        ...
        if (job.strategyType()
            ...
            throw new IllegalArgumentException(
                    "Invalid strategy for native move executor"
            );
        }

        if (!job.sourceSourceId()
                .equals(
        ...
        if (!job.sourceConnectionId()
            ...
            throw new IllegalArgumentException(
                    "Native move requires the same Google Drive connection"
            );
        }
    }
